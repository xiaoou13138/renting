...
<body>
<div class="bg" style="background-color: #e7e9ff" id="mainBlock">
    <div style="width: 80%;margin:auto">
        <div class="container-fluid" >
            <div class="row" style="margin-top: 50px">
                <div class="col-xs-offset-2 col-xs-5"><input type="text"  class="form-control" id="searchContent"></div>
                <a class="col-xs-1 search-button btn-primary no-line" onclick="getPostCardInfo(0,10,true)">搜索</a>
            </div>
            <div class="row" style="margin-top: 50px">
                <div class="col-md-9" style="background-color: #e7e9ff" id="card">
                    <div class="row">
                        ...
                        <div class=" col-xs-2">
                            <select class="form-control" id ="houseLimit" onchange="getPostCardInfo(0,10,true)">
                        ...
                        <div class=" col-xs-2">
                            <select class="form-control" id ="sexLimit" onchange="getPostCardInfo(0,10,true)">
                ...
                <div class="col-md-3" id="createButton">
                    <div class="row">
...
<script>
    ...
    function createPostInfoHtml(value){
        ...
        var title = "<div class='col-xs-9 text-left'style='font-size: 17px;color: #0f0f0f'>"+value.hostName+"&nbsp;&nbsp;"+"<a href='./cardDetail?postId="
            +value.postId+"' class='lead '>"
            +value.title+"&nbsp;&nbsp;"+"</a>"+sexLimit+"&nbsp;&nbsp;"+houseLimit+"</div>";
        if(viewType == 2 && userType=='admin'){
            title =title
                +"<div class='col-xs-3'><a href='javascript:void(0)' onclick='deletePostCard("+value.postId+")' style='font-size: 20px;color: red;padding-right: 10px' class='pull-right'>删除</a></div>"
        }
        var html = "<div class='row' style='padding: 10px;border-bottom:1px solid #502c26;'><div class='row' style='padding: 10px;'>"
            ...
            +value.content+"</div><div class='row'style='padding: 10px'>"+
